...
export const LAYOUT_PRESETS: readonly LayoutPreset[] = [
  ...
  },
  {
    id: "osu-mania-7k",
    name: "Mania 7K",
    description: "Seven symmetrical lanes with Space as the wider center key.",
    category: "Rhythm",
    keySize: 100,
    kpsX: 50,
    kpsY: 90,
    keys: [
      presetKey("KeyS", "S", 12, 50),
      presetKey("KeyD", "D", 25, 50),
      presetKey("KeyF", "F", 38, 50),
      presetKey("Space", "SPACE", 50, 50, 140, 100),
      presetKey("KeyJ", "J", 62, 50),
      presetKey("KeyK", "K", 75, 50),
      presetKey("KeyL", "L", 88, 50),
    ],
  },
  {
    id: "wasd-movement",
